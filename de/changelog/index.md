...
- [v0.3.0 — versionierte Laufzeiten, gefilterte Suche, Befehlspalette](https://projectious-work.github.io/brand-theme-hugo-vanilla/de/changelog/release-v0-3-0/index.md) — Laufzeit-Assets sind exakt versioniert, die Suche indexiert Überschriften, und alle Seitenaktionen stehen in einer Zeile.
- [v0.2.0 — Navy-Dunkelmodus und die Barrierefreiheits-Ebene](https://projectious-work.github.io/brand-theme-hugo-vanilla/de/changelog/release-v0-2-0/index.md) — Der Dunkelmodus wechselt auf die Midnight-Skala, und alle Einstellungen sind opt-in.
