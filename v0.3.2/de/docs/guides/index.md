...
- [Leitfaden zur Template-Erstellung](https://projectious-work.github.io/brand-theme-hugo-vanilla/v0.3.2/de/docs/guides/template-authoring/index.md) — Upgrade-sichere Hugo-Layouts und Shortcodes mit Theme-Tokens und Tailwind erstellen.
