...
- [Getting started](https://projectious-work.github.io/brand-theme-hugo-vanilla/docs/getting-started/index.md) — Create a Hugo site from scratch, install the theme from a release or local checkout, configure its outputs and run it.
- [Configuration](https://projectious-work.github.io/brand-theme-hugo-vanilla/docs/configuration/index.md) — Configure the whole site and control individual pages through front matter.
