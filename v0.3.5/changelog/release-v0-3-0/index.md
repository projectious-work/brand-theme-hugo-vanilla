# v0.3.0 — pinned runtimes, section-filtered search, command palette

> Runtime assets are version-pinned, search indexes headings, and every page action sits in one row.
...
they share one row on docs pages, section indexes and release notes. The sidebar's
"Tools" group is gone.
...
---
Source: https://projectious-work.github.io/brand-theme-hugo-vanilla/v0.3.5/changelog/release-v0-3-0/index.md
