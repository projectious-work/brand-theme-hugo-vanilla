...
- [Template authoring guide](https://projectious-work.github.io/brand-theme-hugo-vanilla/v0.3.5/docs/guides/template-authoring/index.md) — Move from Markdown authoring to your first upgrade-safe Hugo shortcode and layout, step by step.
