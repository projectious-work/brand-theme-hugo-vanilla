...
- [Guide de création de templates](https://projectious-work.github.io/brand-theme-hugo-vanilla/v0.3.6/fr/docs/guides/template-authoring/index.md) — Créer des layouts et shortcodes Hugo maintenables avec les jetons du thème et Tailwind.
